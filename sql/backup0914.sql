...
INSERT INTO `brand` VALUES (1,'APPLE','apple .inc','/images/brand/Apple.png'),(2,'Acer',NULL,'/images/brand/Acer.png'),(3,'ASUS',NULL,'/images/brand/Asus.png'),(4,'Miscroft',NULL,'/images/brand/Miscroft.png'),(5,'Lenovo',NULL,'/images/brand/Lenovo.png'),(6,'DELL',NULL,'/images/brand/Dell.png'),(7,'HP',NULL,'/images/brand/Hp.png'),(8,'LG',NULL,'/images/brand/Lg.png'),(9,'MSI',NULL,'/images/brand/Msi.png'),(999,'other',NULL,'');
...
INSERT INTO `orders` VALUES (1,6,'2023-08-25 00:00:00','買家一的收件人','台中市中區臺灣大道一段1號','0912345678',2,1,0),(2,6,'2023-08-26 07:10:00','買家一的收件人','台中市中區臺灣大道一段1號','0912345678',0,0,0),(3,7,'2023-08-25 14:12:15','買家2的收件人','台中市中區臺灣大道一段1號','0912345678',2,1,0),(4,7,'2023-08-25 14:13:22','買家2的收件人','台中市中區臺灣大道一段1號','0912345678',1,1,1),(5,6,'2023-08-27 07:10:00','買家一的收件人','台中市中區臺灣大道一段1號','0912345678',1,0,0);
...
--
-- Table structure for table `product_images_test`
--

DROP TABLE IF EXISTS `product_images_test`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `product_images_test` (
  ...
  `pord_info` tinyint(4) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  KEY `prod_id` (`prod_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `product_images_test`
--

LOCK TABLES `product_images_test` WRITE;
/*!40000 ALTER TABLE `product_images_test` DISABLE KEYS */;
/*!40000 ALTER TABLE `product_images_test` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `shopcart` VALUES (6,1,0),(6,1,1),(6,7,0),(6,9,2),(6,11,1),(7,13,0);
...
-- Dump completed on 2023-09-14 13:30:12
